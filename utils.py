...
class TextLoader():
    def __init__(self, data_dir, batch_size, seq_length, encoding=None):
        ...
        book_filenames = sorted(glob.glob(os.path.join(data_dir, "*.txt")))
        input_files = book_filenames
        ...
        if True or not (os.path.exists(vocab_file) and os.path.exists(tensor_file)):
            ...
            self.preprocess(input_files, vocab_file, tensor_file, encoding)
        else:
    ...
    def preprocess(self, input_files, vocab_file, tensor_file, encoding):
        data = u""
